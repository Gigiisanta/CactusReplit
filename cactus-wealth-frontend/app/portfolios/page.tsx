...
export default function PortfoliosPage() {
  ...
  const calculateTotalWeight = (positions: ModelPortfolioPosition[]) => {
    return positions.reduce((total, position) => total + Number(position.weight), 0);
  };
  ...
  return (
    <div className="container mx-auto py-8 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Gestión de Carteras Modelo</h1>
          <p className="text-muted-foreground">
            Cree y gestione plantillas de carteras basadas en ponderación porcentual de activos
          </p>
        </div>
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Defina los detalles básicos de la nueva cartera modelo. Podrá agregar activos después.
              </DialogDescription>
            </DialogHeader>
      ...
      {portfolios.length === 0 ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <h3 className="text-lg font-semibold mb-2">No hay carteras modelo</h3>
            <p className="text-gray-500 text-center mb-4">
              Comience creando su primera cartera modelo para estandarizar las estrategias de inversión.
            </p>
