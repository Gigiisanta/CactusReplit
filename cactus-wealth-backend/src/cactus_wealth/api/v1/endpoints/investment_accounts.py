...
from cactus_wealth.schemas import InvestmentAccountCreate, InvestmentAccountRead, InvestmentAccountUpdate
...
@router.post("/clients/{client_id}/investment-accounts/", response_model=InvestmentAccountRead, status_code=status.HTTP_201_CREATED)
...
@router.get("/clients/{client_id}/investment-accounts/", response_model=List[InvestmentAccountRead])
